...
function decreaseMoodAndFitness() {
  ...
  setInterval(() => {
    ...
    if (powerLevel % 50 === 0 && powerLevel !== storedPowerLevel) {
      ...
      var max_tokens = 200;
      var temperature = 0.8;
      var prompt = `Imagine you are a cute virtual pet owned by a young radio producer names Espe. \n\n As her pet, you must learn about Boys Planet 999, the South Korean boy group reality survival show to form a global K-pop boy group, from this fan discussion on the latets episode: \n" ${file_contents2}. \n\n Your mood and fitness levels change when Espe interacts with you. \n\nYour mood and fitness level ranges from 0 to 1000, the higher they are the happier and more fit you are. Your mood state right now is ${pet.mood} and fitness level is ${pet.fitness}. Speaking like a kawaii anime animal character, here are ten words or less that express the virtual pet fitness and mood states and references Boy Planet 999:\n\n`;
